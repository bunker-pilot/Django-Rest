...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title="Chicken")
        r2 = create_recipe(user=self.user, title="Sample")
        tag1 = Tag.objects.create(user=self.user, name="Celery")
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title="Heavennly bamboo")

        in1 = Ingredient.objects.create(user=self.user, name="Feta chese")
        in2 = Ingredient.objects.create(user=self.user, name="Celery")

        r1.ingredients.add(in1)
        r2.ingredients.add(in2)

        r3 = create_recipe(user=self.user, title="Aush")
